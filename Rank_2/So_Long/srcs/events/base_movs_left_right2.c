...
void	pass_through_exit_left2(t_main_struct *boss, t_win *win)
{
...
void	mov_left2(t_main_struct *boss, t_win *win)
{
	...
	if (win->mapa[win->player_y][win->player_x - 1] != '1')
	{
		...
		pass_through_exit_left2(boss, win);
...
void	pass_through_exit_right2(t_main_struct *boss, t_win *win)
{
	if (win->mapa[win->player_y][win->player_x] == 'P')
	{
		boss->img = pass_exit2(boss);
...
void	mov_right2(t_main_struct *boss, t_win *win)
{
	...
	if (win->mapa[win->player_y][win->player_x + 1] != '1')
	{
		...
		pass_through_exit_right2(boss, win);
